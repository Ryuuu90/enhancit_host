...
const DistributionChartScores = ({normalDistributions, processAllData ,reportType, DisType}) => {
    ...
    return (
        <div className=" bg-[#161616] rounded-2xl shadow p-4">
            <div className="w-[100%] h-[100%]   flex flex-col justify-start items-center">
                <h2 className="text-xl text-[#8f8d9f] font-bold  text-">{DisType} of Scores</h2>
                    ...
                    <ResponsiveContainer width="100%"  height="95%">
                        <ComposedChart className=" mt-6 -ml-6" >
                            ...
                            {DisType === "Normal Distributions" && categories.map((category)=>(
                                <Area type="monotone"  dataKey="y" data={normalDistributions[category].points} name={category} id={category} stroke={categoryColors[category]} fill={categoryColors[category] + 70} />
